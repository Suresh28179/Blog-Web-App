...
<body>
  ...
  <main class="l-main">
    ...
    <section class="home bd-grid section" id="home">
      <div class="home-data">
        <h2 class="home-title">
          Hi 👋,<br />I'am <span class="home-title-color">Suresh</span><br />
         <span id="jobTitle" >PHP Developer</span> 
        </h2>
      ...
      <div class="home-social">
        <a href="https://www.linkedin.com/in/suresh-shanmugasundaram-7590ab279" target="_blank" class="home-social-icon"><i
            class="bx bxl-linkedin"></i></a>
        <a href="https://github.com/Suresh28179" target="_blank" class="home-social-icon"><i
    ...
    <section class="about section" id="about">
      ...
      <div class="about-container bd-grid">
        <div class="about-img">
          <img src="assets/img/Developer_logo.png" alt="" />
        </div>

        <div style="text-align: center">
          <h2 class="about-subtitle">I'am Suresh</h2>
          <p class="about-text">
            Quick learner and an aspiring full-stack web developer with core
            knowledge of PHP technology. Looking forward to applying
            and enhancing my skills and knowledge as a developer.
          </p>
          <br />
          
          <p>
            Drop a mail ssureshoffl@gmail.com
    ...
    <div class="education-data">
      <div class="education-names">
        ...
        <span class="education-name">B.SC(CS)</span>
        <p class="education-platform ">Sri Jayendra Saraswathy Maha Vidyalaya College of Arts and Science, Durg</p>
        <p class="education-duration ">August 2020 - June 2023</p>
    ...
    <section class="skills section" id="skills">
      ...
      <div class="skills-container bd-grid">
        <div>
          ...
          <div class="skills-data">
            <div class="skills-names">
              <img class="skills-icon" src="./assets/img/php.png" alt="" />
        ...
        <div>
          ...
          <div class="skills-data">
            <div class="skills-names">
              <img class="skills-icon" src="./assets/img/mysql.png" alt="" />
          ...
          <div class="skills-data">
            <div class="skills-names">
              <img class="skills-icon" src="./assets/img/jquery.png" alt="" />
      ...
      <div class="project-container">
        <div class="project-img">
          ...
          <div class="project-btns">
            <a href="https://github.com/Suresh28179" target="_blank" class="small-btn button">
  ...
  <footer class="footer section" id="contact">
    ...
    <p class="footer-title">Suresh Shanmugasundaram</p>
    <div class="footer-social">
      <a href="https://www.linkedin.com/in/suresh-shanmugasundaram-7590ab279" target="_blank" class="footer-icon"><i
      ...
      <a href="" target="_blank" class="footer-icon"><i class="bx bxl-twitter">
          <br />
          Twitter</i></a>
      <a href="ssureshoffl@gmail.com" target="_blank" class="footer-icon"><i class="bx bx-mail-send">
          <br />
          E-mail</i></a>
      <a href="tel:+91 9361880749" target="_blank" class="footer-icon"><i class="bx bx-phone">
          <br />
          Phone</i></a>
      <a href="https://github.com/Suresh28179" target="_blank" class="footer-icon"><i
            class="bx bxl-github">
          <br />
          GitHub
          </i></a>
